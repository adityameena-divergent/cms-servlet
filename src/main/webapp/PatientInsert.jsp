...
<body
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				...
				<a class="navbar-brand" href="AdminMenu.jsp">Admin Menu</a>
	...
	<div class="text-center mt-5">
		<form action="patientInsert" method="post"
			...
			<input type="number" class="form-control"
				placeholder="Patient Age" name="patient_age" required autofocus>
			
			<input type="number" class="form-control"
				placeholder="Patient Weight" name="patient_weight" required autofocus>
